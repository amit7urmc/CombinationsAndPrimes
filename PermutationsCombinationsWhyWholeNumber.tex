...
\begin{document}
	...
	\end{align*}\footnotetext{To be sure that $\binom{3}{2}$ is an integer we have to calculate it, since this is outside the base condition. Equality ($\binom{4}{3} = \binom{3}{3} + \binom{3}{2}$) does not `necessarily' imply integer nature. This holds for $\binom{4}{2}, \binom{5}{2}, \binom{5}{3}, \binom{6}{3}, \binom{6}{2}, \binom{7}{3} \cdots$ and so on}
